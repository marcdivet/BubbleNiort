...
func Bubble(sem chan bool, nomOperation string, difOp float32) {
	...
	//  - et des appels à d'autres microservices, des BD, ... : simulé par des wait
	// il ne faut oublier que les microservices sont un ensemble de fonctions
	// et que ces fonctions n'ont pas le même comportement ...
	...
	for cp1 := 0; cp1 < paramExec.NbTriDansBubble; cp1++ {
		...
		// initialisation du tableau dans la manière la moins favorable au tri à bulle
...
func main() {
	...
	fmt.Printf("build : V31/10/17-11:11\n")
